...
export default function MonthlySummary({ credits, currentDate, onDateChange }: MonthlySummaryProps) {
  const total = credits.reduce((sum, credit) => sum + parseFloat(credit.amount), 0);
    ...
    <Card className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Current Month Summary</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-accent/5 rounded-xl p-4 border border-accent/20">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-1">Avg. Credit</p>
